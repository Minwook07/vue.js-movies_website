<template>
    <section class="py-5">
        <div class="container">
            <h5 class="mb-5"><span class="text-light bg-success rounded-1 py-2 px-4 fw-normal">Chinese Movies</span>
            </h5>
            <div class="row">
...
const countryDramas = computed(() =>
    dramaStore.drama_lists.filter(drama => drama.country === 'chinese')
);
